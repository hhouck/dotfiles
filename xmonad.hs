...
myFont :: String
myFont = "xft:JetBrainsMonoMedium Nerd Font Medium:regular:size=9:antialias=true:hinting=true"
...
myFocusColor :: String
myFocusColor  = "#8ec07c"
-- #46d9ff   -- Border color of focused windows
...
--    spawnOnce "/usr/bin/emacs --daemon &" -- emacs daemon for the emacsclient
    ...
    spawnOnce "urxvtd &"      -- urxvt daemon for better performance
...
myKeys =
    ...
    -- Useful programs to have a keybinding for launch
        ...
        , ("M-M1-g", spawn (myTerminal ++ " -e gotop"))
